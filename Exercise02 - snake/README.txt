...
Logic is really simple. I'm using 2D int array. Head position value is always the length of the snake. If snake moves, then every tail element value is decreased by one. If array value reaches to 0, then there is no more tail anymore. Food value is -2.
